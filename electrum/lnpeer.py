...
from .crypto import blakecoin_lntx_sighash, blakecoin_segwit_sighash, sha256, sha256d, privkey_to_pubkey
...
class Peer(Logger, EventListener):
    ...
    def send_node_announcement(self, alias:str, color_hex:str):
        ...
        raw_msg = encode_msg(
            ...
            addresses=addresses)
        h = blakecoin_lntx_sighash(raw_msg[64+2:])
    ...
    async def _shutdown(self, chan: Channel, payload, *, is_local: bool):
        ...
        def verify_signature(tx: 'PartialTransaction', sig) -> bool:
            ...
            msg_hash = blakecoin_segwit_sighash(pre_hash)
