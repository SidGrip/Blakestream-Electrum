...
extras_require = {
    ...
    'tests': ['pycryptodomex>=3.7', 'cryptography>=2.6', 'pyaes>=0.1a1', 'pytest>=9'],
...
if sys.platform != 'win32' and os.environ.get('SKIP_BLAKE256_EXT') != '1':
    ext_modules.append(Extension(
        '_blake256',
        sources=['blake256/blake256_wrapper.c', 'blake256/blake.c'],
        include_dirs=['blake256'],
