...
class TestLNMsg(ElectrumTestCase):
    ...
    @staticmethod
    def encoded_channel_update_fixture() -> bytes:
        return (
            bfh("0102" + "00" * 64)
            + constants.net.rev_genesis_bytes()
            + bfh("00d43100006f00025e6ed0830100009000000000000000c8000001f400000023000000003b9aca00")
        )
    ...
    def test_encode_decode_msg__missing_mandatory_field_gets_set_to_zeroes(self):
        ...
        expected_channel_update = self.encoded_channel_update_fixture()
        self.assertEqual(expected_channel_update,
                         encode_msg(
                             "channel_update",
        ...
        self.assertEqual(('channel_update',
                         ...
                         decode_msg(expected_channel_update))
    ...
    def test_encode_decode_msg__init(self):
        ...
        self.assertEqual(bfh("00100000000220c20120") + constants.net.rev_genesis_bytes(),
                         encode_msg(
                             "init",
                             gflen=0,
                             flen=2,
        ...
        self.assertEqual(('init',
                         ...
                         decode_msg(bfh("001000022200000302aaa20120") + constants.net.rev_genesis_bytes()))
